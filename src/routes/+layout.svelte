	...
	<div class="max-w-6xl mx-auto px-4">
		<div class="flex justify-between">
			<div class="flex space-x-4">
				<!-- lo3go -->
				<div>					
				<a href="/" title="Förderverein Schutzhaus Dreisessel">
					<img style="height: 60px;" src="/logo_small.png" alt="Förderverein Schutzhaus Dreisessel">
				</a>			
				</div>
				<!-- primary nav -->
			...
			<div class="md:hidden flex items-center cursor-pointer" on:click="{toggleMenu}">
				<div class="space-y-2">
