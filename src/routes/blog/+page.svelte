...
<section class="py-20 bg-white">
	<div class="flex flex-col px-8 mx-auto space-y-12 max-w-7xl xl:px-12">
		<div class="relative">
			<h1 class="font-bold text-3xl mb-4 text-gruen">Aktuelles</h1>
			<p class="mb-6">
				...
				<div class="row justify-content-center">
					<div class="col-md-8">
						<div class="row">
							...
							{:else}
							<div role="status">
								<svg class="inline mr-2 w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-gruen" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
